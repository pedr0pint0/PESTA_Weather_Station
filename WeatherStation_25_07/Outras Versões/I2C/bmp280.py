...
BMP280_ADDRESS = 0x77  # Endereço do sensor 
...
def temperature():
    ...
    adc_T = (t_data[0] << 12) | (t_data[1] << 4) | (t_data[2] >> 4) #unpack so funciona para 2 ou 4 nao 3 T_T
...
if __name__ == "__main__":
    ...
    altitude = 44330 * (1 - (press / 102000) ** (1/5.255)) #102000 pressao ao nivel do mar porto
    print(f"Altitude: {altitude:.2f} m")

    print(f"T: {temp:.2f}°C")
    print(f"P: {press / 100:.2f}Pa")
